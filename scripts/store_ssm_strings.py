...
def handler(event, context):
    ...
    ssm.put_parameter(
        Name=f'/{prefix}/baseline/data_quality_statistics',
    ...
    ssm.put_parameter(
        Name=f'/{prefix}/baseline/data_quality_constraints',
    ...
    ssm.put_parameter(
        Name=f'/{prefix}/baseline/model_bias_statistics',
    ...
    ssm.put_parameter(
        Name=f'/{prefix}/baseline/model_bias_constraints',
